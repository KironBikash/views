    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <form class="form-vertical" role="form" method="post" action="/signin">
                ...
                <div class="text-center">
                    <h5>INSERT FOOD NAME.</h5>
                </div>

                <div class="form-group {{ $errors->has('deletefood') ? 'has-error' : ''}}" >
                    <label for="deletefood" class="control-label">Food Name</label>
                    <input type="text" class="form-control" name="deletefood" id="deletefood" value="" />
                    
                    @if($errors->has('deletefood'))
                    <span class="help-block"> {{ $errors->first('deletefood')}} </span>                    
                    @endif
                </div>
